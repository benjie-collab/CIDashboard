...
$config['message_start_delimiter'] = '<div class="alert alert-dismissable alert-info"><i class="fa fa-exclamation-circle"></i>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-dismissable alert-danger"><i class="fa fa-exclamation-circle"></i>';		// Error message start delimiter
