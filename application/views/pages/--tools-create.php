...
<div id="floating-tool-content" class="no-print floating-tools-content" data-bind="
	...
	$atts = array(
			'class' => '',
			'data-bind' => 'submit: $root.Pages.createPage', 
			'method' => 'POST',
			'onSubmit' => 'return false;',
			'id' => ''
	);
	
	$hidden 		= array('meta_key' => 'pages');	
	?>			
	<?php echo form_open( '/pages/create/', $atts, $hidden ); ?>
	...
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs pull-right ui-sortable-handle">
		  ...
		  <li class="pull-left header">New Page</li>
		</ul>
		...
		<div class="box-footer">	
			<button type="submit" class="btn btn-primary btn-flat">Save Page</button>
		</div>	
	<?=form_close()?>
</div>
