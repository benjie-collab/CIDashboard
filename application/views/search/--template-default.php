...
<section class="p-relative content">
	<div class="info-box" id="widget-bin"
		data-bind="jQueryDroppable: {
					activeClass: 'sort-highlight bg-red',					
	...
	>
		<span class="info-box-icon bg-red"><i class="ion ion-ios-trash-outline"></i></span>
		<div class="info-box-content">
		  <span class="info-box-text">Drop widgets to remove.</span>
	...
	<div class="edit-template">
				...
				<div class="draggable-widgets-container p-0">
					...
					<div class="p-5 droppable-widgets m-0 widget"
							data-bind="
								...
								jQuerySortable: {
									connectWith: '.droppable-widgets, #widget-bin',
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="draggable-widgets-container p-0">
					<?php 
						$hidden = array('meta_key' => 'widget_right_sidebar_1');
						echo form_open('search/save_widget',  array('data-bind' => 'submit: $root.SearchTemplate.formSubmit', 'onSubmit' => 'return false;'), $hidden );						
					?>
					<div class="p-5 droppable-widgets m-0 widget widget-sm"
							data-bind="
						...
						>	
							<?php 
							if(!empty($widgets_current['right_sidebar_1'])):
							foreach($widgets_current['right_sidebar_1'] as $key=>$widget):				
							$wid = $widgets[$widget];
							?>					
				...
				<div class="draggable-widgets-container p-0">
					<?php 
						$hidden = array('meta_key' => 'widget_right_sidebar_2');
						echo form_open('search/save_widget',  array('data-bind' => 'submit: $root.SearchTemplate.formSubmit', 'onSubmit' => 'return false;'), $hidden );						
					?>
					<div class="p-5 droppable-widgets m-0 widget widget-sm"
							data-bind="
						...
						>	
							<?php 
							if(!empty($widgets_current['right_sidebar_2'])):
							foreach($widgets_current['right_sidebar_2'] as $key=>$widget):				
							$wid = $widgets[$widget];
							?>					
