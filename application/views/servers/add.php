<section class="content-header">
  <h1>
	<?php echo lang('create_server_heading');?>
	<small><?php echo lang('create_server_subheading');?></small>
  </h1>
...
<?php 
	$atts = array(
			...
			'data-bind' => 'submit: $root.Servers.createServer', 
...
<section class="content">	
	...
	<div class="row">
		<div class="col-md-9">
			<?php echo form_open("servers/add", $atts, $hidden);?>
