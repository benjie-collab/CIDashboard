...
<?php 
	...
	$options	=  $this->search_model->get_options('settings_query_getcontent');
	...
	$atts = array(
			...
			'id' => 'settings_query_getcontent_form'
	);	
	$hidden 		= array('meta_key' => 'settings_query_getcontent');
...
<?php echo form_open( '/settings', $atts, $hidden ); ?>
	<div class="box-body">
			...
			<p class="lead"><?=lang('getcotnent_description') ?></p>			
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				   <?php
					...
					<p class="help-block"><?=lang('getcotnent_'.$name)?></p>
				</div>
			</div>
			<?php		
			}
