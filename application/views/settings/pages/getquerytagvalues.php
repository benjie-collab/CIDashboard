...
<?php 
	...
	$options	=  $this->search_model->get_options('settings_tag_getquerytagvalues');
	...
	$atts = array(
			...
			'id' => 'settings_tag_getquerytagvalues_form'
	);	
	$hidden 		= array('meta_key' => 'settings_tag_getquerytagvalues');
...
<?php echo form_open( '/settings', $atts, $hidden ); ?>
	<div class="box-body">
			...
			<p class="lead"><?=lang('getquerytagvalues_description') ?></p>			
