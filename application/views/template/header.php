...
<head>
	<?php 		
		...
		if(is_page() && isset($page) && element('skin', $page)){
			$skin = element('skin', $page);
		}
	...
	<link href="<?= base_url('assets/lib/bootstrap.wysihtml5/css/bootstrap3-wysihtml5.css'); ?>" rel="stylesheet" type="text/css">
