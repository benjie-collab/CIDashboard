					...
					<div class="form-group">
						...
						<div class="col-sm-9" >		
						   <?php 
								...
								$value	= array_get_value($options, 'summary');
								$atts = 'class=" form-control" data-max-options="5" data-size="5" data-bind="BootstrapSelect:{}" ';
								echo form_dropdown( 'query[summary]', element('summary', $av_options), $value, $atts);
							?>
							<p class="help-block">Some help text</p>
