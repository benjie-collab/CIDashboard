			...
			<div class="tab-content p-0 p-t-20">
				<div id="options-tab-1" class="tab-pane active">
					<fieldset class="scheduler-border">
						<legend class="scheduler-border">Template</legend>
						<ul class="products-list m-b-20">
							<li class="">
							  ...
							  <div class="product-info">
								<div class="bg-orange p-t-10 p-b-10 w-75">
								...
								<span class="product-description d-block p-t-10 p-b-20 bg-primary m-t-5 w-50"></span>
							  </div>
							</li><!-- /.item -->
						</ul>
						
						<div class="form-group">
							<label class="col-sm-3 control-label" for="doc_thumbnail"><span class="p-5 bg-gray"></span></label>	
							<div class="col-sm-9" >			
								<?php 
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="doc_meta"><span class="p-5 bg-maroon"></span></label>	
							<div class="col-sm-9" >			
								<?php 
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="doc_comments"><span class="p-5 bg-primary"></span></label>	
							<div class="col-sm-9" >			
								<?php 
									$elements = array_merge(
											$this->document_lib->elements(null, array('action'=>'GetTagNames', 'responseformat'=>'json','text'=>'*', 'FieldType' => 'HIGHLIGHT'),false),
											$this->document_lib->elements(null, array('action'=>'GetTagNames', 'responseformat'=>'json','text'=>'*', 'FieldType' => 'INDEX') )											
											);
									$atts = 'class="form-control selectpicker" data-live-search="true" data-max-options="5" multiple data-size="5" data-bind="BootstrapSelect:{}"';
									$selected = array_key_exists('doc_comments', $options)? $options['doc_comments'] : array();
									echo form_dropdown('doc_comments[]', $elements, $selected, $atts);
								?>
							</div>	
						</div>
					</fieldset>
