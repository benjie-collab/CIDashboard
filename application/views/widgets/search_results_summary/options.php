...
$querysummary 	= $this->application->get_session_userdata('search_querysummary');
$fields 	  	= is_array($querysummary)? array_keys(array_shift($querysummary)) : array();
$fields 		= $fields?array_combine($fields, $fields):array();
...
echo form_open( '/app/widget_options/', $atts, $hidden ); ?>
	...
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs pull-right">
			...
			<li><a data-toggle="tab" data-target="#options-tab-2" href="javascript:void(0)">Visualization</a></li>
			<li><a data-toggle="tab" data-target="#options-tab-3" href="javascript:void(0)">Data</a></li>
		</ul>
		<div class="tab-content">
			...
			<div id="options-tab-2" class="tab-pane">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="font">Font</label>
					<div class="col-sm-9">
						<?php 
			...
			<div id="options-tab-3" class="tab-pane">	
				<div class="form-group">
					<label class="col-sm-3 control-label" for="termfield">termfield</label>
					<div class="col-sm-9">
						<?php 
							$atts = 'class="form-control selectpicker" data-live-search="true" data-size="8" data-bind="BootstrapSelect:{}"';
							$selected = array_key_exists('termfield', $data_options)? element('termfield', $data_options) : '';
							echo form_dropdown('data[termfield]', $fields, $selected, $atts);
						?>
						<p class="help-block"><?=lang('search_form_options_title_help_text')?></p>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="termcount">termcount</label>
					<div class="col-sm-9">
						<?php 
							$atts = 'class="form-control selectpicker" data-live-search="true" data-size="8" data-bind="BootstrapSelect:{}"';
							$selected = array_key_exists('termcount', $data_options)? element('termcount', $data_options) : '';
							echo form_dropdown('data[termcount]', $fields, $selected, $atts);
						?>
						<p class="help-block"><?=lang('search_form_options_title_help_text')?></p>
					</div>
				</div>
